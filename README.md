...
2. Repository name: **`novoretail-analytics`**
...
git branch -M main
git remote add origin https://github.com/ShrutiDubal/novoretail-analytics.git
...
```powershell
git remote set-url origin https://github.com/ShrutiDubal/novoretail-analytics.git
git push -u origin main
```
...
2. **New app** → repo: `ShrutiDubal/novoretail-analytics`
3. **Main file path:** `app.py`
4. **Deploy**

Live URL: `https://novoretail-analytics.streamlit.app`
